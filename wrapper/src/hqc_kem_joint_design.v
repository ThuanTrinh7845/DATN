...
//	DECAP operation  = 2'b10
	...
	// lephucuong fix and add
	output [`CLOG2(X)-1:0] e_h_addr_0,
	output [`CLOG2(X)-1:0] e_h_addr_1,
	output [`CLOG2(X)-1:0] d_h_addr_0,
	output [`CLOG2(X)-1:0] d_h_addr_1,
	// lephucuong fix and add
	...
	// lephucuong fix and add
	output [`CLOG2(X)-1:0] e_s_addr_0,
	output [`CLOG2(X)-1:0] e_s_addr_1,
	output [`CLOG2(X)-1:0] d_s_addr_0,
	output [`CLOG2(X)-1:0] d_s_addr_1,
	//lephucuong fix and add
...
assign encap_inside_decap = 1'b0;
