...
(* mark_debug = "true" *) wire [3:0]   dbg_onegen_state;
(* mark_debug = "true" *) wire [LOG_WEIGHT:0] dbg_onegen_count;
(* mark_debug = "true" *) wire [LOG_WEIGHT-1:0] dbg_onegen_rd_addr;
(* mark_debug = "true" *) wire [M-1:0] dbg_onegen_location;

// Collision signals
(* mark_debug = "true" *) wire         dbg_collision_s;
(* mark_debug = "true" *) wire         dbg_collision_reg;
(* mark_debug = "true" *) wire         dbg_collision_reg_reg;
(* mark_debug = "true" *) wire         dbg_wren_1;

// BRAM data
(* mark_debug = "true" *) wire [WIDTH-1:0] dbg_q_0;
(* mark_debug = "true" *) wire [WIDTH-1:0] dbg_data_1;
(* mark_debug = "true" *) wire [WIDTH-1:0] dbg_gen_one_rev;
(* mark_debug = "true" *) wire [LOGW-1:0]  dbg_decode_addr;
(* mark_debug = "true" *) wire [3:0]       dbg_count_sim_cycles;

// connect
assign dbg_onegen_state      = state;
assign dbg_onegen_count      = count_reg;
assign dbg_onegen_rd_addr    = rd_addr;
assign dbg_onegen_location   = location;
assign dbg_collision_s       = collision_s;
assign dbg_collision_reg     = collision_reg;
assign dbg_collision_reg_reg = collision_reg_reg;
assign dbg_wren_1            = wren_1;
assign dbg_q_0               = q_0;
assign dbg_data_1            = data_1;
assign dbg_gen_one_rev       = gen_one_reg_rev;
assign dbg_decode_addr       = decode_addr;
assign dbg_count_sim_cycles  = count_sim_cycles;
// end ILA
endmodule