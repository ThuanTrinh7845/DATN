...
// add ILA
(* mark_debug = "true" *) wire [3:0]  dbg_keygen_state;
(* mark_debug = "true" *) wire [3:0]  dbg_trx_state;
(* mark_debug = "true" *) wire        dbg_start;
(* mark_debug = "true" *) wire        dbg_done_fw;
(* mark_debug = "true" *) wire        dbg_x_transfer_done;
(* mark_debug = "true" *) wire [1:0]  dbg_request_another_vector;
(* mark_debug = "true" *) wire        dbg_start_fw;
(* mark_debug = "true" *) wire        dbg_sel_fw;
(* mark_debug = "true" *) wire        dbg_shake_force_done;

assign dbg_keygen_state          = state;
assign dbg_trx_state             = trx_state;
assign dbg_start                 = start;
assign dbg_done_fw               = done_fw;
assign dbg_x_transfer_done       = x_transfer_done;
assign dbg_request_another_vector = request_another_vector;
assign dbg_start_fw              = start_fw;
assign dbg_sel_fw                = sel_fw;
assign dbg_shake_force_done      = shake_force_done;
 // end ILA   
 
 // add ILA 2

(* mark_debug = "true" *) wire [LOG_WEIGHT-1:0] dbg_x_addr;
(* mark_debug = "true" *) wire [LOG_WEIGHT-1:0] dbg_x_addr_reg;
(* mark_debug = "true" *) wire        dbg_wen_x;
(* mark_debug = "true" *) wire        dbg_sel_x;
(* mark_debug = "true" *) wire        dbg_rd_x;
(* mark_debug = "true" *) wire [M-1:0] dbg_error_loc;
(* mark_debug = "true" *) wire [M-1:0] dbg_x_internal;

assign dbg_x_addr     = x_addr;
assign dbg_x_addr_reg = x_addr_reg;
assign dbg_wen_x      = wen_x;
assign dbg_sel_x      = sel_x;
assign dbg_rd_x       = rd_x;
assign dbg_error_loc  = error_loc;
assign dbg_x_internal = x_internal;
//end ILA 2

// ===================== ILA PS?PL DATA CHECK =====================
(* mark_debug = "true" *) wire [31:0] dbg_sk_seed;
(* mark_debug = "true" *) wire [3:0]  dbg_sk_seed_addr;
(* mark_debug = "true" *) wire        dbg_sk_seed_wen;
(* mark_debug = "true" *) wire [31:0] dbg_pk_seed;
(* mark_debug = "true" *) wire [3:0]  dbg_pk_seed_addr;
(* mark_debug = "true" *) wire        dbg_pk_seed_wen;
(* mark_debug = "true" *) wire        dbg_rst;

assign dbg_sk_seed      = sk_seed;
assign dbg_sk_seed_addr  = sk_seed_addr;
assign dbg_sk_seed_wen   = sk_seed_wen;
assign dbg_pk_seed      = pk_seed;
assign dbg_pk_seed_addr  = pk_seed_addr;
assign dbg_pk_seed_wen   = pk_seed_wen;
assign dbg_rst           = rst;
// ================================================================
endmodule